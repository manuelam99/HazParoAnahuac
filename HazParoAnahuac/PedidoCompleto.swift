...
struct PedidoCompleto: View {
   ...
   func leeJSONWeb() async throws-> [ParoElement] {
       ...
       an.append(a)
       @State var urlconsumo: String = "https://pf-pdmii.glitch.me/paros/solicitante/6269accea7abe6a6287d89f1/completos"
            print (urlconsumo)
        ...
        List(self.paros)
            {
                ...
                NavigationLink(destination: DetalleFavor(paro : par)){
                    ElementoListaParo(paro: par, color:"",titulo: "Pedidos Completo")
                }
            }
            .task
            {
...
struct PedidoCompleto_Previews: PreviewProvider {
